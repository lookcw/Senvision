...
NewsSourceUris=[er.getNewsSourceUri("Los Angeles Times"),er.getNewsSourceUri("Business Insider"),
er.getNewsSourceUri("Bloomberg"),er.getNewsSourceUri("Wall Street Journal"),er.getNewsSourceUri("CNBC"),er.getNewsSourceUri("BBC"),
er.getNewsSourceUri("Yahoo Finance"),er.getNewsSourceUri("Forbes"),er.getNewsSourceUri("Financial Times")]
...
def getArticlesUrls(queryterm,startdate,enddate):
	...
	companyfolderpath="../Spec_Comp_Urls/"+folder_name
...
sourceUri=NewsSourceUris)
	...
	# find articles mentioning the company of the queryterm	
	q.addConcept(er.getConceptUri(queryterm))
	# print er.getNewsSourceUri("Los Angeles Times")
	# print er.getNewsSourceUri("Bloomberg")
	# print er.getNewsSourceUri("Wall Street Journal")
	# print er.getNewsSourceUri("CNBC")
	# print er.getNewsSourceUri("BBC")
	# print er.getNewsSourceUri("Yahoo Finance")
